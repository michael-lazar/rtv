...
The <kbd>/</kbd> key opens a text prompt at the bottom of the screen. You can then
type in the name of the subreddit that you would like to open. The following
